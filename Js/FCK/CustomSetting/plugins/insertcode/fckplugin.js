...
FCKCommands.RegisterCommand('InsertCode',new FCKDialogCommand( 'InsertCode', FCKLang["InsertCodeTitle"], FCKPlugins.Items['insertcode'].Path + 'fck_insertcode.html', 550, 390 ) ) ;


var oInsertCode=new FCKToolbarButton('InsertCode',null,FCKLang["InsertCodeBtn"],null,false,true,48);

oInsertCode.IconPath = FCKPlugins.Items['insertcode'].Path + 'ico.png' ;
